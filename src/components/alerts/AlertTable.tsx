    ...
    <div className="rounded-xl border bg-white shadow-sm dark:bg-slate-800 dark:border-slate-700 overflow-hidden">
      ...
      {alerts.length === 0 && (
        <div className="flex flex-col items-center justify-center py-16 px-4">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-100 to-green-200 dark:from-emerald-900/30 dark:to-green-900/30 flex items-center justify-center mb-4 shadow-sm">
        ...
        <>
          <div className="hidden md:block overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b bg-slate-50/80 text-left text-xs font-semibold uppercase tracking-wider text-slate-500 dark:bg-slate-900/80 dark:text-slate-400 dark:border-slate-700">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-800 flex items-center justify-center text-sm font-bold text-slate-600 dark:text-slate-300 shrink-0">
      ...
      {pagination && pagination.totalPages > 1 && (
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-t px-4 py-4 bg-slate-50/80 dark:bg-slate-900/80 dark:border-slate-700">
          {/* Info Text */}
          ...
          <div className="flex items-center gap-2 order-1 sm:order-2">
            ...
            <span className="sm:hidden px-2 py-1 text-sm text-slate-600 dark:text-slate-400">
