      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3">
        <div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[var(--cpems-offline)] flex items-center justify-center shadow-sm">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-xs sm:text-sm">
                Pemantauan Alarm & Event Real-time
              </p>
            </div>
          </div>
        </div>
      ...
      {isLoading && !response && (
        <div className="flex flex-col items-center justify-center py-16">
          <div className="relative">
            ...
            <div className="w-12 h-12 rounded-full border-4 border-[var(--cpems-offline)] border-t-transparent animate-spin absolute inset-0" />
          </div>
          <p className="mt-4 text-sm text-muted-foreground">Memuat alerts...</p>
        </div>
      )}
